pipeline {
    ...
    parameters {
        ...
        string(defaultValue: "", description: 'Copy Carthage folder from cache? Enter Yes to enable (NOTICE: it builds faster, but may cause build issues)', name: 'cache_carthage')
    }
